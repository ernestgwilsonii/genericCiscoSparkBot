...
@YourBotsName ping TARGET                <-- Displays this help message\n \
@YourBotsName zipcode lookup US zip      <-- Lookup a zipcode using a Country Code and Zipcode\n \
Hint: To command a bot in a group space, you need to direct mention the @bot's name (type using @ symbol). \n \
``` \n \
[Need a two letter Country Code click here](http://zippopotam.us/#where)";
module.exports.sparkBotHelpDirectMention = sparkBotHelpDirectMention;
////////////////////////////////////////////////////////////////////////////////
...
``` \n";
module.exports.sparkBotHelpDirectMessage = sparkBotHelpDirectMessage;
////////////////////////////////////////////////////////////////////////////////
